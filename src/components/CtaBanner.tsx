...
export function CtaBanner({
  ...
  return (
    <section className="panel p-8 md:p-12 grid md:grid-cols-[auto_1fr_auto] gap-8 items-center relative overflow-hidden">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2 max-w-md">{body}</p>
      </div>
      <div className="flex flex-col items-start md:items-end gap-3">
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 bg-primary text-primary-foreground rounded-full px-6 py-3 font-semibold hover:opacity-90 transition"
        >
