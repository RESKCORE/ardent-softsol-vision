...
export const Route = createFileRoute("/career")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join Ardent Softsol and shape the future. Browse open roles in development, mobile, QA, and DevOps from our Vancouver, BC office." },
      { name: "keywords", content: "software developer jobs Vancouver BC, full stack developer career, mobile app developer jobs, QA engineer jobs, DevOps engineer careers, tech jobs Canada" },
